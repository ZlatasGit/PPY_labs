...
Original file is located at
    https://colab.research.google.com/drive/1xbaOjAnCZd5lRXv9vFgPGBsy2kEkPWl5
...
# Define variable
number = int(input("Enter a number: "))
divider = int(input("Enter a second number: "))

# Check if the number is even or odd
if number % divider == 0:
    result = "Can be divided"
else:
    result = "Cannot be divided"
